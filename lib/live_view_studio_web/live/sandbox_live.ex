defmodule LiveViewStudioWeb.SandboxLive do
  ...
  def mount(_params, _session, socket) do
    initial_values = [length: "0", width: "0", depth: "0", weight: 0.0, price: nil]
    socket = assign(socket, initial_values)
    {:ok, socket}
  end
  ...
  def handle_event("calculate", params, socket) do
    ...
    socket =
      assign(socket, weight: weight, width: width, length: length, depth: depth, price: nil)
